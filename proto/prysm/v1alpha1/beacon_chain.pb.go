...
type BeaconBlockContainer struct {
	...
	//	*BeaconBlockContainer_Eip7805Block
	//	*BeaconBlockContainer_BlindedEip7805Block
...
func (x *BeaconBlockContainer) GetEip7805Block() *SignedBeaconBlockEip7805 {
	if x, ok := x.GetBlock().(*BeaconBlockContainer_Eip7805Block); ok {
		return x.Eip7805Block
	}
	return nil
}

func (x *BeaconBlockContainer) GetBlindedEip7805Block() *SignedBlindedBeaconBlockEip7805 {
	if x, ok := x.GetBlock().(*BeaconBlockContainer_BlindedEip7805Block); ok {
		return x.BlindedEip7805Block
	}
	return nil
}
...
type BeaconBlockContainer_Eip7805Block struct {
	Eip7805Block *SignedBeaconBlockEip7805 `protobuf:"bytes,15,opt,name=eip7805_block,json=eip7805Block,proto3,oneof"`
}

type BeaconBlockContainer_BlindedEip7805Block struct {
	BlindedEip7805Block *SignedBlindedBeaconBlockEip7805 `protobuf:"bytes,16,opt,name=blinded_eip7805_block,json=blindedEip7805Block,proto3,oneof"`
}
...
func (*BeaconBlockContainer_Eip7805Block) isBeaconBlockContainer_Block() {}

func (*BeaconBlockContainer_BlindedEip7805Block) isBeaconBlockContainer_Block() {}
...
var file_proto_prysm_v1alpha1_beacon_chain_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x92, 0x0b, 0x0a, 0x14, 0x42, 0x65, 0x61, 0x63,
	...
	,
...
var file_proto_prysm_v1alpha1_beacon_chain_proto_goTypes = []interface{}{
	...
	(*SignedBeaconBlockEip7805)(nil),              // 57: ethereum.eth.v1alpha1.SignedBeaconBlockEip7805
	(*SignedBlindedBeaconBlockEip7805)(nil),       // 58: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockEip7805
	(*ValidatorParticipation)(nil),                // 59: ethereum.eth.v1alpha1.ValidatorParticipation
	(*Validator)(nil),                             // 60: ethereum.eth.v1alpha1.Validator
	(*emptypb.Empty)(nil),                         // 61: google.protobuf.Empty
	(*AttesterSlashing)(nil),                      // 62: ethereum.eth.v1alpha1.AttesterSlashing
	(*AttesterSlashingElectra)(nil),               // 63: ethereum.eth.v1alpha1.AttesterSlashingElectra
	(*ProposerSlashing)(nil),                      // 64: ethereum.eth.v1alpha1.ProposerSlashing
}
var file_proto_prysm_v1alpha1_beacon_chain_proto_depIdxs = []int32{
	...
	57, // 17: ethereum.eth.v1alpha1.BeaconBlockContainer.eip7805_block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockEip7805
	58, // 18: ethereum.eth.v1alpha1.BeaconBlockContainer.blinded_eip7805_block:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockEip7805
	35, // 19: ethereum.eth.v1alpha1.BeaconCommittees.committees:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteesEntry
	36, // 20: ethereum.eth.v1alpha1.ValidatorBalances.balances:type_name -> ethereum.eth.v1alpha1.ValidatorBalances.Balance
	37, // 21: ethereum.eth.v1alpha1.Validators.validator_list:type_name -> ethereum.eth.v1alpha1.Validators.ValidatorContainer
	38, // 22: ethereum.eth.v1alpha1.ValidatorAssignments.assignments:type_name -> ethereum.eth.v1alpha1.ValidatorAssignments.CommitteeAssignment
	59, // 23: ethereum.eth.v1alpha1.ValidatorParticipationResponse.participation:type_name -> ethereum.eth.v1alpha1.ValidatorParticipation
	41, // 24: ethereum.eth.v1alpha1.AttestationPoolResponse.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	42, // 25: ethereum.eth.v1alpha1.AttestationPoolElectraResponse.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	39, // 26: ethereum.eth.v1alpha1.BeaconConfig.config:type_name -> ethereum.eth.v1alpha1.BeaconConfig.ConfigEntry
	40, // 27: ethereum.eth.v1alpha1.IndividualVotesRespond.individual_votes:type_name -> ethereum.eth.v1alpha1.IndividualVotesRespond.IndividualVote
	33, // 28: ethereum.eth.v1alpha1.BeaconCommittees.CommitteesList.committees:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteeItem
	34, // 29: ethereum.eth.v1alpha1.BeaconCommittees.CommitteesEntry.value:type_name -> ethereum.eth.v1alpha1.BeaconCommittees.CommitteesList
	60, // 30: ethereum.eth.v1alpha1.Validators.ValidatorContainer.validator:type_name -> ethereum.eth.v1alpha1.Validator
	1,  // 31: ethereum.eth.v1alpha1.BeaconChain.ListAttestations:input_type -> ethereum.eth.v1alpha1.ListAttestationsRequest
	1,  // 32: ethereum.eth.v1alpha1.BeaconChain.ListAttestationsElectra:input_type -> ethereum.eth.v1alpha1.ListAttestationsRequest
	0,  // 33: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestations:input_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsRequest
	0,  // 34: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestationsElectra:input_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsRequest
	26, // 35: ethereum.eth.v1alpha1.BeaconChain.AttestationPool:input_type -> ethereum.eth.v1alpha1.AttestationPoolRequest
	26, // 36: ethereum.eth.v1alpha1.BeaconChain.AttestationPoolElectra:input_type -> ethereum.eth.v1alpha1.AttestationPoolRequest
	6,  // 37: ethereum.eth.v1alpha1.BeaconChain.ListBeaconBlocks:input_type -> ethereum.eth.v1alpha1.ListBlocksRequest
	61, // 38: ethereum.eth.v1alpha1.BeaconChain.GetChainHead:input_type -> google.protobuf.Empty
	10, // 39: ethereum.eth.v1alpha1.BeaconChain.ListBeaconCommittees:input_type -> ethereum.eth.v1alpha1.ListCommitteesRequest
	12, // 40: ethereum.eth.v1alpha1.BeaconChain.ListValidatorBalances:input_type -> ethereum.eth.v1alpha1.ListValidatorBalancesRequest
	14, // 41: ethereum.eth.v1alpha1.BeaconChain.ListValidators:input_type -> ethereum.eth.v1alpha1.ListValidatorsRequest
	15, // 42: ethereum.eth.v1alpha1.BeaconChain.GetValidator:input_type -> ethereum.eth.v1alpha1.GetValidatorRequest
	17, // 43: ethereum.eth.v1alpha1.BeaconChain.GetValidatorActiveSetChanges:input_type -> ethereum.eth.v1alpha1.GetValidatorActiveSetChangesRequest
	61, // 44: ethereum.eth.v1alpha1.BeaconChain.GetValidatorQueue:input_type -> google.protobuf.Empty
	19, // 45: ethereum.eth.v1alpha1.BeaconChain.GetValidatorPerformance:input_type -> ethereum.eth.v1alpha1.ValidatorPerformanceRequest
	22, // 46: ethereum.eth.v1alpha1.BeaconChain.ListValidatorAssignments:input_type -> ethereum.eth.v1alpha1.ListValidatorAssignmentsRequest
	24, // 47: ethereum.eth.v1alpha1.BeaconChain.GetValidatorParticipation:input_type -> ethereum.eth.v1alpha1.GetValidatorParticipationRequest
	61, // 48: ethereum.eth.v1alpha1.BeaconChain.GetBeaconConfig:input_type -> google.protobuf.Empty
	62, // 49: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashing:input_type -> ethereum.eth.v1alpha1.AttesterSlashing
	63, // 50: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashingElectra:input_type -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	64, // 51: ethereum.eth.v1alpha1.BeaconChain.SubmitProposerSlashing:input_type -> ethereum.eth.v1alpha1.ProposerSlashing
	31, // 52: ethereum.eth.v1alpha1.BeaconChain.GetIndividualVotes:input_type -> ethereum.eth.v1alpha1.IndividualVotesRequest
	2,  // 53: ethereum.eth.v1alpha1.BeaconChain.ListAttestations:output_type -> ethereum.eth.v1alpha1.ListAttestationsResponse
	3,  // 54: ethereum.eth.v1alpha1.BeaconChain.ListAttestationsElectra:output_type -> ethereum.eth.v1alpha1.ListAttestationsElectraResponse
	4,  // 55: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestations:output_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsResponse
	5,  // 56: ethereum.eth.v1alpha1.BeaconChain.ListIndexedAttestationsElectra:output_type -> ethereum.eth.v1alpha1.ListIndexedAttestationsElectraResponse
	27, // 57: ethereum.eth.v1alpha1.BeaconChain.AttestationPool:output_type -> ethereum.eth.v1alpha1.AttestationPoolResponse
	28, // 58: ethereum.eth.v1alpha1.BeaconChain.AttestationPoolElectra:output_type -> ethereum.eth.v1alpha1.AttestationPoolElectraResponse
	7,  // 59: ethereum.eth.v1alpha1.BeaconChain.ListBeaconBlocks:output_type -> ethereum.eth.v1alpha1.ListBeaconBlocksResponse
	9,  // 60: ethereum.eth.v1alpha1.BeaconChain.GetChainHead:output_type -> ethereum.eth.v1alpha1.ChainHead
	11, // 61: ethereum.eth.v1alpha1.BeaconChain.ListBeaconCommittees:output_type -> ethereum.eth.v1alpha1.BeaconCommittees
	13, // 62: ethereum.eth.v1alpha1.BeaconChain.ListValidatorBalances:output_type -> ethereum.eth.v1alpha1.ValidatorBalances
	16, // 63: ethereum.eth.v1alpha1.BeaconChain.ListValidators:output_type -> ethereum.eth.v1alpha1.Validators
	60, // 64: ethereum.eth.v1alpha1.BeaconChain.GetValidator:output_type -> ethereum.eth.v1alpha1.Validator
	18, // 65: ethereum.eth.v1alpha1.BeaconChain.GetValidatorActiveSetChanges:output_type -> ethereum.eth.v1alpha1.ActiveSetChanges
	21, // 66: ethereum.eth.v1alpha1.BeaconChain.GetValidatorQueue:output_type -> ethereum.eth.v1alpha1.ValidatorQueue
	20, // 67: ethereum.eth.v1alpha1.BeaconChain.GetValidatorPerformance:output_type -> ethereum.eth.v1alpha1.ValidatorPerformanceResponse
	23, // 68: ethereum.eth.v1alpha1.BeaconChain.ListValidatorAssignments:output_type -> ethereum.eth.v1alpha1.ValidatorAssignments
	25, // 69: ethereum.eth.v1alpha1.BeaconChain.GetValidatorParticipation:output_type -> ethereum.eth.v1alpha1.ValidatorParticipationResponse
	29, // 70: ethereum.eth.v1alpha1.BeaconChain.GetBeaconConfig:output_type -> ethereum.eth.v1alpha1.BeaconConfig
	30, // 71: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashing:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	30, // 72: ethereum.eth.v1alpha1.BeaconChain.SubmitAttesterSlashingElectra:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	30, // 73: ethereum.eth.v1alpha1.BeaconChain.SubmitProposerSlashing:output_type -> ethereum.eth.v1alpha1.SubmitSlashingResponse
	32, // 74: ethereum.eth.v1alpha1.BeaconChain.GetIndividualVotes:output_type -> ethereum.eth.v1alpha1.IndividualVotesRespond
...
func file_proto_prysm_v1alpha1_beacon_chain_proto_init() {
	...
	file_proto_prysm_v1alpha1_beacon_chain_proto_msgTypes[8].OneofWrappers = []interface{}{
		...
		(*BeaconBlockContainer_Eip7805Block)(nil),
		(*BeaconBlockContainer_BlindedEip7805Block)(nil),
	}
