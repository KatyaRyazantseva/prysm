...
type GenericSignedBeaconBlock struct {
	...
	//	*GenericSignedBeaconBlock_Eip7805
	//	*GenericSignedBeaconBlock_BlindedEip7805
...
func (x *GenericSignedBeaconBlock) GetEip7805() *SignedBeaconBlockContentsEip7805 {
	if x, ok := x.GetBlock().(*GenericSignedBeaconBlock_Eip7805); ok {
		return x.Eip7805
	}
	return nil
}

func (x *GenericSignedBeaconBlock) GetBlindedEip7805() *SignedBlindedBeaconBlockEip7805 {
	if x, ok := x.GetBlock().(*GenericSignedBeaconBlock_BlindedEip7805); ok {
		return x.BlindedEip7805
	}
	return nil
}
...
type GenericSignedBeaconBlock_Eip7805 struct {
	Eip7805 *SignedBeaconBlockContentsEip7805 `protobuf:"bytes,13,opt,name=eip7805,proto3,oneof"`
}

type GenericSignedBeaconBlock_BlindedEip7805 struct {
	BlindedEip7805 *SignedBlindedBeaconBlockEip7805 `protobuf:"bytes,14,opt,name=blinded_eip7805,json=blindedEip7805,proto3,oneof"`
}
...
func (*GenericSignedBeaconBlock_Eip7805) isGenericSignedBeaconBlock_Block() {}

func (*GenericSignedBeaconBlock_BlindedEip7805) isGenericSignedBeaconBlock_Block() {}
...
type GenericBeaconBlock struct {
	...
	//	*GenericBeaconBlock_Eip7805
	//	*GenericBeaconBlock_BlindedEip7805
...
func (x *GenericBeaconBlock) GetEip7805() *BeaconBlockContentsEip7805 {
	if x, ok := x.GetBlock().(*GenericBeaconBlock_Eip7805); ok {
		return x.Eip7805
	}
	return nil
}

func (x *GenericBeaconBlock) GetBlindedEip7805() *BlindedBeaconBlockEip7805 {
	if x, ok := x.GetBlock().(*GenericBeaconBlock_BlindedEip7805); ok {
		return x.BlindedEip7805
	}
	return nil
}
...
type GenericBeaconBlock_Eip7805 struct {
	Eip7805 *BeaconBlockContentsEip7805 `protobuf:"bytes,13,opt,name=eip7805,proto3,oneof"`
}

type GenericBeaconBlock_BlindedEip7805 struct {
	BlindedEip7805 *BlindedBeaconBlockEip7805 `protobuf:"bytes,14,opt,name=blinded_eip7805,json=blindedEip7805,proto3,oneof"`
}
...
func (*GenericBeaconBlock_Eip7805) isGenericBeaconBlock_Block() {}

func (*GenericBeaconBlock_BlindedEip7805) isGenericBeaconBlock_Block() {}
...
type SignedBeaconBlockContentsEip7805 struct {
	...
	Block     *SignedBeaconBlockEip7805 `protobuf:"bytes,1,opt,name=block,proto3" json:"block,omitempty"`
	KzgProofs [][]byte                  `protobuf:"bytes,2,rep,name=kzg_proofs,json=kzgProofs,proto3" json:"kzg_proofs,omitempty" ssz-max:"4096" ssz-size:"?,48"`
	Blobs     [][]byte                  `protobuf:"bytes,3,rep,name=blobs,proto3" json:"blobs,omitempty" ssz-max:"4096" ssz-size:"?,131072"`
}

func (x *SignedBeaconBlockContentsEip7805) Reset() {
	*x = SignedBeaconBlockContentsEip7805{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedBeaconBlockContentsEip7805) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBeaconBlockContentsEip7805) ProtoMessage() {}

func (x *SignedBeaconBlockContentsEip7805) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[66]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBeaconBlockContentsEip7805.ProtoReflect.Descriptor instead.
func (*SignedBeaconBlockContentsEip7805) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{66}
}

func (x *SignedBeaconBlockContentsEip7805) GetBlock() *SignedBeaconBlockEip7805 {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *SignedBeaconBlockContentsEip7805) GetKzgProofs() [][]byte {
	if x != nil {
		return x.KzgProofs
	}
	return nil
...
func (x *SignedBeaconBlockContentsEip7805) GetBlobs() [][]byte {
	if x != nil {
		return x.Blobs
	}
	return nil
...
func (x *SignedBeaconBlockEip7805) Reset() {
	*x = SignedBeaconBlockEip7805{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedBeaconBlockEip7805) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBeaconBlockEip7805) ProtoMessage() {}

func (x *SignedBeaconBlockEip7805) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[67]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBeaconBlockEip7805.ProtoReflect.Descriptor instead.
func (*SignedBeaconBlockEip7805) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{67}
}

func (x *SignedBeaconBlockEip7805) GetBlock() *BeaconBlockElectra {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *SignedBeaconBlockEip7805) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *BeaconBlockContentsEip7805) Reset() {
	*x = BeaconBlockContentsEip7805{}
	if protoimpl.UnsafeEnabled {
...
func (x *BeaconBlockContentsEip7805) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BeaconBlockContentsEip7805) ProtoMessage() {}

func (x *BeaconBlockContentsEip7805) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[68]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BeaconBlockContentsEip7805.ProtoReflect.Descriptor instead.
func (*BeaconBlockContentsEip7805) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{68}
}

func (x *BeaconBlockContentsEip7805) GetBlock() *BeaconBlockElectra {
	if x != nil {
		return x.Block
	}
	return nil
...
func (x *BeaconBlockContentsEip7805) GetKzgProofs() [][]byte {
	if x != nil {
		return x.KzgProofs
	}
	return nil
...
func (x *BeaconBlockContentsEip7805) GetBlobs() [][]byte {
	if x != nil {
		return x.Blobs
	}
	return nil
...
type SignedBlindedBeaconBlockEip7805 struct {
	...
	Message   *BlindedBeaconBlockEip7805 `protobuf:"bytes,1,opt,name=message,proto3" json:"message,omitempty"`
	Signature []byte                     `protobuf:"bytes,2,opt,name=signature,proto3" json:"signature,omitempty" ssz-size:"96"`
}

func (x *SignedBlindedBeaconBlockEip7805) Reset() {
	*x = SignedBlindedBeaconBlockEip7805{}
	if protoimpl.UnsafeEnabled {
...
func (x *SignedBlindedBeaconBlockEip7805) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SignedBlindedBeaconBlockEip7805) ProtoMessage() {}

func (x *SignedBlindedBeaconBlockEip7805) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[69]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SignedBlindedBeaconBlockEip7805.ProtoReflect.Descriptor instead.
func (*SignedBlindedBeaconBlockEip7805) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{69}
}

func (x *SignedBlindedBeaconBlockEip7805) GetMessage() *BlindedBeaconBlockEip7805 {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *SignedBlindedBeaconBlockEip7805) GetSignature() []byte {
	if x != nil {
		return x.Signature
	}
	return nil
...
func (x *BlindedBeaconBlockEip7805) Reset() {
	*x = BlindedBeaconBlockEip7805{}
	if protoimpl.UnsafeEnabled {
...
func (x *BlindedBeaconBlockEip7805) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*BlindedBeaconBlockEip7805) ProtoMessage() {}

func (x *BlindedBeaconBlockEip7805) ProtoReflect() protoreflect.Message {
	mi := &file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[70]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use BlindedBeaconBlockEip7805.ProtoReflect.Descriptor instead.
func (*BlindedBeaconBlockEip7805) Descriptor() ([]byte, []int) {
	return file_proto_prysm_v1alpha1_beacon_block_proto_rawDescGZIP(), []int{70}
}

func (x *BlindedBeaconBlockEip7805) GetSlot() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot {
	if x != nil {
		return x.Slot
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.Slot(0)
...
func (x *BlindedBeaconBlockEip7805) GetProposerIndex() github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex {
	if x != nil {
		return x.ProposerIndex
	}
	return github_com_prysmaticlabs_prysm_v5_consensus_types_primitives.ValidatorIndex(0)
...
func (x *BlindedBeaconBlockEip7805) GetParentRoot() []byte {
	if x != nil {
		return x.ParentRoot
	}
	return nil
...
func (x *BlindedBeaconBlockEip7805) GetStateRoot() []byte {
	if x != nil {
		return x.StateRoot
	}
	return nil
...
func (x *BlindedBeaconBlockEip7805) GetBody() *BlindedBeaconBlockBodyElectra {
	if x != nil {
		return x.Body
	}
	return nil
...
var file_proto_prysm_v1alpha1_beacon_block_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x84, 0x0a, 0x0a, 0x18, 0x47, 0x65, 0x6e, 0x65, 0x72, 0x69, 0x63,
	...
	0x64, 0x46, 0x75, 0x6c, 0x75, 0x12, 0x53, 0x0a, 0x07, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35,
	0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x37, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x48,
	0x00, 0x52, 0x07, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x61, 0x0a, 0x0f, 0x62, 0x6c,
	0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x18, 0x0e, 0x20,
	...
	0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x48, 0x00, 0x52, 0x0e, 0x62,
	0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x1d, 0x0a,
	0x0a, 0x69, 0x73, 0x5f, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x18, 0x64, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x09, 0x69, 0x73, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x07, 0x0a, 0x05,
	0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x4a, 0x04, 0x08, 0x65, 0x10, 0x66, 0x22, 0xc9, 0x09, 0x0a, 0x12,
	...
	0x6e, 0x74, 0x73, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x48, 0x00, 0x52, 0x05, 0x64, 0x65, 0x6e, 0x65,
	0x62, 0x12, 0x55, 0x0a, 0x0d, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x64, 0x65, 0x6e,
	0x65, 0x62, 0x18, 0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72,
	0x65, 0x75, 0x6d, 0x2e, 0x65, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x31,
	...
	0x64, 0x65, 0x64, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x12, 0x4d, 0x0a, 0x07, 0x65, 0x6c, 0x65, 0x63,
	0x74, 0x72, 0x61, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x31, 0x2e, 0x65, 0x74, 0x68, 0x65,
	...
	0x65, 0x6c, 0x65, 0x63, 0x74, 0x72, 0x61, 0x12, 0x5b, 0x0a, 0x0f, 0x62, 0x6c, 0x69, 0x6e, 0x64,
	...
	0x72, 0x61, 0x48, 0x00, 0x52, 0x0e, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x45, 0x6c, 0x65,
	0x63, 0x74, 0x72, 0x61, 0x12, 0x44, 0x0a, 0x04, 0x66, 0x75, 0x6c, 0x75, 0x18, 0x0b, 0x20, 0x01,
	...
	0x6c, 0x75, 0x48, 0x00, 0x52, 0x04, 0x66, 0x75, 0x6c, 0x75, 0x12, 0x52, 0x0a, 0x0c, 0x62, 0x6c,
	0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x66, 0x75, 0x6c, 0x75, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0b,
	...
	0x00, 0x52, 0x0b, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x46, 0x75, 0x6c, 0x75, 0x12, 0x4d,
	0x0a, 0x07, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x73, 0x45, 0x69, 0x70, 0x37, 0x38,
	0x30, 0x35, 0x48, 0x00, 0x52, 0x07, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x5b, 0x0a,
	0x0f, 0x62, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x5f, 0x65, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35,
	0x18, 0x0e, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x30, 0x2e, 0x65, 0x74, 0x68, 0x65, 0x72, 0x65, 0x75,
	...
	0x6b, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x48, 0x00, 0x52, 0x0e, 0x62, 0x6c, 0x69, 0x6e,
	0x64, 0x65, 0x64, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73,
	...
	0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x22, 0x73, 0x0a, 0x11, 0x53, 0x69, 0x67, 0x6e, 0x65,
	...
	0x36, 0x52, 0x09, 0x73, 0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xec, 0x02, 0x0a,
	0x0b, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x12, 0x59, 0x0a, 0x04,
	...
	0x75, 0x72, 0x65, 0x22, 0xdb, 0x02, 0x0a, 0x11, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c,
	...
	0x64, 0x65, 0x78, 0x22, 0x72, 0x0a, 0x1e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x56, 0x61, 0x6c,
	...
	0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x22, 0xf3, 0x06, 0x0a,
	...
	0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43,
	0x61, 0x70, 0x65, 0x6c, 0x6c, 0x61, 0x12, 0x46, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18,
	...
	0x8d, 0x07, 0x0a, 0x1d, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f,
	...
	0x62, 0x6b, 0x65, 0x79, 0x22, 0xc2, 0x01, 0x0a, 0x1e, 0x53, 0x69, 0x67, 0x6e, 0x65, 0x64, 0x42,
	0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e,
	0x74, 0x73, 0x44, 0x65, 0x6e, 0x65, 0x62, 0x12, 0x43, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b,
	...
	0x39, 0x36, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x62, 0x73, 0x22, 0x7d, 0x0a, 0x16, 0x53, 0x69, 0x67,
	...
	0x69, 0x67, 0x6e, 0x61, 0x74, 0x75, 0x72, 0x65, 0x22, 0xb6, 0x01, 0x0a, 0x18, 0x42, 0x65, 0x61,
	...
	0x73, 0x22, 0xf6, 0x02, 0x0a, 0x10, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63,
	...
	0x30, 0x39, 0x36, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x62, 0x73, 0x22, 0xfa, 0x02, 0x0a, 0x12, 0x42,
	...
	,
	...
	,
	...
	0x37, 0x38, 0x30, 0x35, 0x12, 0x3f, 0x0a, 0x05, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20,
	...
	0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x43, 0x6f, 0x6e, 0x74, 0x65,
	0x6e, 0x74, 0x73, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x3f, 0x0a, 0x05, 0x62, 0x6c,
	...
	0x36, 0x52, 0x05, 0x62, 0x6c, 0x6f, 0x62, 0x73, 0x22, 0x93, 0x01, 0x0a, 0x1f, 0x53, 0x69, 0x67,
	0x6e, 0x65, 0x64, 0x42, 0x6c, 0x69, 0x6e, 0x64, 0x65, 0x64, 0x42, 0x65, 0x61, 0x63, 0x6f, 0x6e,
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x4a, 0x0a, 0x07,
	...
	0x63, 0x6f, 0x6e, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x52,
	...
	0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x45, 0x69, 0x70, 0x37, 0x38, 0x30, 0x35, 0x12, 0x59, 0x0a, 0x04,
	0x73, 0x6c, 0x6f, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x42, 0x45, 0x82, 0xb5, 0x18, 0x41,
	0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x72, 0x79, 0x73, 0x6d,
	0x61, 0x74, 0x69, 0x63, 0x6c, 0x61, 0x62, 0x73, 0x2f, 0x70, 0x72, 0x79, 0x73, 0x6d, 0x2f, 0x76,
	0x35, 0x2f, 0x63, 0x6f, 0x6e, 0x73, 0x65, 0x6e, 0x73, 0x75, 0x73, 0x2d, 0x74, 0x79, 0x70, 0x65,
	...
	0x74, 0x72, 0x61, 0x52, 0x04, 0x62, 0x6f, 0x64, 0x79, 0x42, 0x9b, 0x01, 0x0a, 0x19, 0x6f, 0x72,
...
var file_proto_prysm_v1alpha1_beacon_block_proto_goTypes = []interface{}{
	...
	(*SignedBeaconBlockContentsEip7805)(nil),  // 66: ethereum.eth.v1alpha1.SignedBeaconBlockContentsEip7805
	(*SignedBeaconBlockEip7805)(nil),          // 67: ethereum.eth.v1alpha1.SignedBeaconBlockEip7805
	(*BeaconBlockContentsEip7805)(nil),        // 68: ethereum.eth.v1alpha1.BeaconBlockContentsEip7805
	(*SignedBlindedBeaconBlockEip7805)(nil),   // 69: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockEip7805
	(*BlindedBeaconBlockEip7805)(nil),         // 70: ethereum.eth.v1alpha1.BlindedBeaconBlockEip7805
...
var file_proto_prysm_v1alpha1_beacon_block_proto_depIdxs = []int32{
	...
	66,  // 12: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.eip7805:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockContentsEip7805
	69,  // 13: ethereum.eth.v1alpha1.GenericSignedBeaconBlock.blinded_eip7805:type_name -> ethereum.eth.v1alpha1.SignedBlindedBeaconBlockEip7805
	3,   // 14: ethereum.eth.v1alpha1.GenericBeaconBlock.phase0:type_name -> ethereum.eth.v1alpha1.BeaconBlock
	20,  // 15: ethereum.eth.v1alpha1.GenericBeaconBlock.altair:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
	24,  // 16: ethereum.eth.v1alpha1.GenericBeaconBlock.bellatrix:type_name -> ethereum.eth.v1alpha1.BeaconBlockBellatrix
	27,  // 17: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_bellatrix:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	30,  // 18: ethereum.eth.v1alpha1.GenericBeaconBlock.capella:type_name -> ethereum.eth.v1alpha1.BeaconBlockCapella
	33,  // 19: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_capella:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockCapella
	39,  // 20: ethereum.eth.v1alpha1.GenericBeaconBlock.deneb:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsDeneb
	43,  // 21: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_deneb:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	53,  // 22: ethereum.eth.v1alpha1.GenericBeaconBlock.electra:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsElectra
	57,  // 23: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_electra:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	63,  // 24: ethereum.eth.v1alpha1.GenericBeaconBlock.fulu:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsFulu
	65,  // 25: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_fulu:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockFulu
	68,  // 26: ethereum.eth.v1alpha1.GenericBeaconBlock.eip7805:type_name -> ethereum.eth.v1alpha1.BeaconBlockContentsEip7805
	70,  // 27: ethereum.eth.v1alpha1.GenericBeaconBlock.blinded_eip7805:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockEip7805
	3,   // 28: ethereum.eth.v1alpha1.SignedBeaconBlock.block:type_name -> ethereum.eth.v1alpha1.BeaconBlock
	4,   // 29: ethereum.eth.v1alpha1.BeaconBlock.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBody
	7,   // 30: ethereum.eth.v1alpha1.BeaconBlockBody.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 31: ethereum.eth.v1alpha1.BeaconBlockBody.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 32: ethereum.eth.v1alpha1.BeaconBlockBody.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 33: ethereum.eth.v1alpha1.BeaconBlockBody.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 34: ethereum.eth.v1alpha1.BeaconBlockBody.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 35: ethereum.eth.v1alpha1.BeaconBlockBody.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	6,   // 36: ethereum.eth.v1alpha1.SignedBeaconBlockHeader.header:type_name -> ethereum.eth.v1alpha1.BeaconBlockHeader
	5,   // 37: ethereum.eth.v1alpha1.ProposerSlashing.header_1:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	5,   // 38: ethereum.eth.v1alpha1.ProposerSlashing.header_2:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	10,  // 39: ethereum.eth.v1alpha1.AttesterSlashing.attestation_1:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	10,  // 40: ethereum.eth.v1alpha1.AttesterSlashing.attestation_2:type_name -> ethereum.eth.v1alpha1.IndexedAttestation
	73,  // 41: ethereum.eth.v1alpha1.IndexedAttestation.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	71,  // 42: ethereum.eth.v1alpha1.Deposit.data:type_name -> ethereum.eth.v1alpha1.Deposit.Data
	13,  // 43: ethereum.eth.v1alpha1.SignedVoluntaryExit.exit:type_name -> ethereum.eth.v1alpha1.VoluntaryExit
	15,  // 44: ethereum.eth.v1alpha1.SignedValidatorRegistrationsV1.messages:type_name -> ethereum.eth.v1alpha1.SignedValidatorRegistrationV1
	16,  // 45: ethereum.eth.v1alpha1.SignedValidatorRegistrationV1.message:type_name -> ethereum.eth.v1alpha1.ValidatorRegistrationV1
	18,  // 46: ethereum.eth.v1alpha1.SignedBuilderBid.message:type_name -> ethereum.eth.v1alpha1.BuilderBid
	74,  // 47: ethereum.eth.v1alpha1.BuilderBid.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	20,  // 48: ethereum.eth.v1alpha1.SignedBeaconBlockAltair.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockAltair
	21,  // 49: ethereum.eth.v1alpha1.BeaconBlockAltair.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyAltair
	7,   // 50: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 51: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 52: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 53: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 54: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 55: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 56: ethereum.eth.v1alpha1.BeaconBlockBodyAltair.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	24,  // 57: ethereum.eth.v1alpha1.SignedBeaconBlockBellatrix.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockBellatrix
	25,  // 58: ethereum.eth.v1alpha1.BeaconBlockBellatrix.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix
	7,   // 59: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 60: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 61: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 62: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 63: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 64: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 65: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	75,  // 66: ethereum.eth.v1alpha1.BeaconBlockBodyBellatrix.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayload
	27,  // 67: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockBellatrix.block:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix
	28,  // 68: ethereum.eth.v1alpha1.BlindedBeaconBlockBellatrix.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix
	7,   // 69: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 70: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 71: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 72: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 73: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 74: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 75: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	74,  // 76: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyBellatrix.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeader
	...
	7,   // 79: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	72,  // 82: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	...
	22,  // 85: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	76,  // 86: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadCapella
	77,  // 87: ethereum.eth.v1alpha1.BeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	...
	7,   // 90: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	...
	72,  // 93: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 94: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	...
	22,  // 96: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	78,  // 97: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	77,  // 98: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyCapella.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	36,  // 99: ethereum.eth.v1alpha1.SignedBuilderBidCapella.message:type_name -> ethereum.eth.v1alpha1.BuilderBidCapella
	78,  // 100: ethereum.eth.v1alpha1.BuilderBidCapella.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderCapella
	38,  // 101: ethereum.eth.v1alpha1.SignedBeaconBlockContentsDeneb.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockDeneb
	40,  // 102: ethereum.eth.v1alpha1.SignedBeaconBlockDeneb.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockDeneb
	40,  // 103: ethereum.eth.v1alpha1.BeaconBlockContentsDeneb.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockDeneb
	41,  // 104: ethereum.eth.v1alpha1.BeaconBlockDeneb.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyDeneb
	7,   // 105: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 106: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 107: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 108: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 109: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 110: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 111: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	79,  // 112: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	77,  // 113: ethereum.eth.v1alpha1.BeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	43,  // 114: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockDeneb.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb
	44,  // 115: ethereum.eth.v1alpha1.BlindedBeaconBlockDeneb.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb
	7,   // 116: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 117: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	9,   // 118: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashing
	72,  // 119: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.attestations:type_name -> ethereum.eth.v1alpha1.Attestation
	11,  // 120: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 121: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 122: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	80,  // 123: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	77,  // 124: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyDeneb.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	46,  // 125: ethereum.eth.v1alpha1.SignedBuilderBidDeneb.message:type_name -> ethereum.eth.v1alpha1.BuilderBidDeneb
	80,  // 126: ethereum.eth.v1alpha1.BuilderBidDeneb.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	80,  // 127: ethereum.eth.v1alpha1.BuilderBidElectra.header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	81,  // 128: ethereum.eth.v1alpha1.BuilderBidElectra.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	47,  // 129: ethereum.eth.v1alpha1.SignedBuilderBidElectra.message:type_name -> ethereum.eth.v1alpha1.BuilderBidElectra
	50,  // 130: ethereum.eth.v1alpha1.BlobSidecars.sidecars:type_name -> ethereum.eth.v1alpha1.BlobSidecar
	5,   // 131: ethereum.eth.v1alpha1.BlobSidecar.signed_block_header:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockHeader
	52,  // 132: ethereum.eth.v1alpha1.SignedBeaconBlockContentsElectra.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockElectra
	54,  // 133: ethereum.eth.v1alpha1.SignedBeaconBlockElectra.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	54,  // 134: ethereum.eth.v1alpha1.BeaconBlockContentsElectra.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	55,  // 135: ethereum.eth.v1alpha1.BeaconBlockElectra.body:type_name -> ethereum.eth.v1alpha1.BeaconBlockBodyElectra
	7,   // 136: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 137: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	59,  // 138: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	82,  // 139: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	11,  // 140: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 141: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 142: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	79,  // 143: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.execution_payload:type_name -> ethereum.engine.v1.ExecutionPayloadDeneb
	77,  // 144: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	81,  // 145: ethereum.eth.v1alpha1.BeaconBlockBodyElectra.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	57,  // 146: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockElectra.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockElectra
	58,  // 147: ethereum.eth.v1alpha1.BlindedBeaconBlockElectra.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra
	7,   // 148: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.eth1_data:type_name -> ethereum.eth.v1alpha1.Eth1Data
	8,   // 149: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.proposer_slashings:type_name -> ethereum.eth.v1alpha1.ProposerSlashing
	59,  // 150: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.attester_slashings:type_name -> ethereum.eth.v1alpha1.AttesterSlashingElectra
	82,  // 151: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.attestations:type_name -> ethereum.eth.v1alpha1.AttestationElectra
	11,  // 152: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.deposits:type_name -> ethereum.eth.v1alpha1.Deposit
	12,  // 153: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.voluntary_exits:type_name -> ethereum.eth.v1alpha1.SignedVoluntaryExit
	22,  // 154: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.sync_aggregate:type_name -> ethereum.eth.v1alpha1.SyncAggregate
	80,  // 155: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.execution_payload_header:type_name -> ethereum.engine.v1.ExecutionPayloadHeaderDeneb
	77,  // 156: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.bls_to_execution_changes:type_name -> ethereum.eth.v1alpha1.SignedBLSToExecutionChange
	81,  // 157: ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra.execution_requests:type_name -> ethereum.engine.v1.ExecutionRequests
	60,  // 158: ethereum.eth.v1alpha1.AttesterSlashingElectra.attestation_1:type_name -> ethereum.eth.v1alpha1.IndexedAttestationElectra
	60,  // 159: ethereum.eth.v1alpha1.AttesterSlashingElectra.attestation_2:type_name -> ethereum.eth.v1alpha1.IndexedAttestationElectra
	73,  // 160: ethereum.eth.v1alpha1.IndexedAttestationElectra.data:type_name -> ethereum.eth.v1alpha1.AttestationData
	62,  // 161: ethereum.eth.v1alpha1.SignedBeaconBlockContentsFulu.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockFulu
	54,  // 162: ethereum.eth.v1alpha1.SignedBeaconBlockFulu.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	54,  // 163: ethereum.eth.v1alpha1.BeaconBlockContentsFulu.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	65,  // 164: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockFulu.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockFulu
	58,  // 165: ethereum.eth.v1alpha1.BlindedBeaconBlockFulu.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra
	67,  // 166: ethereum.eth.v1alpha1.SignedBeaconBlockContentsEip7805.block:type_name -> ethereum.eth.v1alpha1.SignedBeaconBlockEip7805
	54,  // 167: ethereum.eth.v1alpha1.SignedBeaconBlockEip7805.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	54,  // 168: ethereum.eth.v1alpha1.BeaconBlockContentsEip7805.block:type_name -> ethereum.eth.v1alpha1.BeaconBlockElectra
	70,  // 169: ethereum.eth.v1alpha1.SignedBlindedBeaconBlockEip7805.message:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockEip7805
	58,  // 170: ethereum.eth.v1alpha1.BlindedBeaconBlockEip7805.body:type_name -> ethereum.eth.v1alpha1.BlindedBeaconBlockBodyElectra
...
func file_proto_prysm_v1alpha1_beacon_block_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[66].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedBeaconBlockContentsEip7805); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[67].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedBeaconBlockEip7805); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[68].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BeaconBlockContentsEip7805); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[69].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SignedBlindedBeaconBlockEip7805); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[70].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*BlindedBeaconBlockEip7805); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[0].OneofWrappers = []interface{}{
		...
		(*GenericSignedBeaconBlock_Eip7805)(nil),
		(*GenericSignedBeaconBlock_BlindedEip7805)(nil),
	}
	file_proto_prysm_v1alpha1_beacon_block_proto_msgTypes[1].OneofWrappers = []interface{}{
		...
		(*GenericBeaconBlock_Eip7805)(nil),
		(*GenericBeaconBlock_BlindedEip7805)(nil),
	}
	type x struct{}
