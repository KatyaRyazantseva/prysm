package eip7805_test

import (
	"testing"

	"github.com/prysmaticlabs/prysm/v5/beacon-chain/core/eip7805"
...
func TestUpgradeToEip7805(t *testing.T) {
	...
	mSt, err := eip7805.UpgradeToEip7805(st)
