...
// UpgradeToEip7805 updates inputs a generic state to return the version EIP-7805 state.
// https://github.com/ethereum/consensus-specs/blob/dev/specs/_features/eip7805/fork.md#upgrading-the-state
func UpgradeToEip7805(beaconState state.BeaconState) (state.BeaconState, error) {
	...
	s := &ethpb.BeaconStateElectra{
		...
		Fork: &ethpb.Fork{
			...
			CurrentVersion:  params.BeaconConfig().Eip7805ForkVersion,
