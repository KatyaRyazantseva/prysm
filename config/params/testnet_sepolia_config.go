...
func SepoliaConfig() *BeaconChainConfig {
	...
	cfg.Eip7805ForkEpoch = math.MaxUint64
	cfg.Eip7805ForkVersion = []byte{0x90, 0x00, 0x00, 0x76} // TODO: Define sepolia fork version for eip7805. This is a placeholder value.
